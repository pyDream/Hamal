...
def check_reach(dest_addr, timeout = 1, count = 2, psize = 64):
    fail = 100
    while 100 == fail:
        print 'check %s can reach'%dest_addr
        fail = quiet_ping(dest_addr, timeout, count, psize)[0]

if __name__ == '__main__':
    verbose_ping("172.20.121.151")
    print quiet_ping('172.20.121.151')
